...
class LinkedinToolException(Exception):
    """
    Exception raised when required LinkedIn environment variables are not set.
    """
    def __init__(self):
...
def scrape_linkedin_posts_fn() -> str:
    """
    Scrapes LinkedIn posts from a specified profile.

    Returns:
        str: A string representation of the latest two LinkedIn posts.

    Raises:
        LinkedinToolException: If the required environment variables are not set.
    """
